...
url = URL.create(
    ...
    username=connect.DBConnect.db_user,
    password=connect.DBConnect.db_password,
    host=connect.DBConnect.host,
    port=connect.DBConnect.port,
    database=connect.DBConnect.db_name
)
